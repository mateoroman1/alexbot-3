...
ALEXBOT_GUILD_ID: Final[int] = 1168671980380229744
...
HARDMODE_HEALTH_MULTIPLIER: Final[float] = 1.15
NIGHTMARE_HEALTH_MULTIPLIER: Final[float] = 1.3
CAMPAIGN_HEALTH_SCALING: Final[float] = 0.15
